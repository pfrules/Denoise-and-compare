function Result=TWSC_Denoising(IMin0,nim,Sigma,Way)
addpath([Way '/'])
Par=Par_Set (Sigma);
Par.I = IMin0/255;
Par.nim=nim/255;
...
function  [Denoising ,AllResult,AllTime] = TWSC_Sigma_AWGN(Par)
im_out    =   Par.nim;
...
AllResult{cnt}=GetAllResult(im_out*255,Par.I*255);
AllTime{cnt}=toc; 
