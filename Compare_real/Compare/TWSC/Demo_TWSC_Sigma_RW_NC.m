...
%-------------------------------------------------------------------------------------------------------------
clear;
TT_Original_image_dir = 'D:\Image-Denoising\Data\nc\';
...
for i = 1 : im_num
    ...
    %% output
        PSNR  =   csnr( IMout*255, Par.I*255, 0, 0 );
    SSIM  =  cal_ssim( IMout*255, Par.I*255, 0, 0 );
    imwrite(IMout, [write_sRGB_dir '/' method '_' dataset '_' IMname '.png']);
    outfile  = sprintf ([write_sRGB_dir '/' method '_' dataset '_' IMname '.txt'], i);
